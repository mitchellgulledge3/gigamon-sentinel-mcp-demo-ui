...
>
> 👉 **[gigamon-sentinel-mcp-demo](https://github.com/mgulledge_microsoft/gigamon-sentinel-mcp-demo)**
...
- **[gigamon-sentinel-mcp-demo](https://github.com/mgulledge_microsoft/gigamon-sentinel-mcp-demo)** — one-command idempotent publish via the Sentinel custom MCP API (`scripts/publish-mcp-tools.py`). Scriptable, re-runnable, and works as part of an ISV's CI/CD or solution-deploy step.
...
- **Recommended:** [gigamon-sentinel-mcp-demo](https://github.com/mgulledge_microsoft/gigamon-sentinel-mcp-demo) — the API-publish reference implementation we're running with.
